...
namespace Tests.Logs
{
    class Log4LiteCart
    {
        ...
        public static void Log()
        {
            ...
            GenerateReport(dateTime, result, className, methodName, arguments,
                String.IsNullOrEmpty(message) ? "-" : message);
        }

        public static void GenerateReport(String iTime, ResultState iResult, String ClassName, String MethodName,
            object[] Arguments, String iMessage)
        {
            ...
            if (Arguments.Length > 0)
            {
                ...
                {
                    arguments += (i == Arguments.Length - 1)
                        ? String.Format("\"{0}\"", Arguments[i])
                        : String.Format("\"{0}\", ", Arguments[i]);
                }
            }

            if (MethodName.Length > 40)
                MethodName = (MethodName.Substring(0, 40) + "</br>" + MethodName.Substring(40, MethodName.Length - 40));
